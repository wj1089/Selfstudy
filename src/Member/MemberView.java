...
public class MemberView extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()=="submitButton") {
			...
			nameText.setText("박우준, 이현명, 필원상, 방주원, 진위");
			useridText.setText("park, lee ,pil, pang , chen");
			passwordText.setText("1,1,1,1,1");
			ssnText.setText("123-1,234-2,345-3,456-4,567-5");
			addrText.setText("서울, 서울, 서울, 평택, 서울");
